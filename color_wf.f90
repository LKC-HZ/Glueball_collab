program color_singlet_reduced_projection
  ...
  if (num_args == 4) then
     ...
     if (arg1(1:2) == '-c' .or. arg1(1:2) == '-C') then
        count_only = .true.
        call get_command_argument(2, arg1); read(arg1, *) n
        call get_command_argument(3, arg2); read(arg2, *) m
        call get_command_argument(4, arg3); read(arg3, *) k
     else
        print *, 'Usage: ./color_wf [-c] n m k'; stop
     end if
