...
# --- color singlets from Fortran color_wf ---
inc_result = colorwf_runner.run_color_wf(inc_qrk_n, inc_antiqrk_n, inc_gl_n)
inc_num_singlets = inc_result.actual_singlets

out_result = colorwf_runner.run_color_wf(out_qrk_n, out_antiqrk_n, out_gl_n)
