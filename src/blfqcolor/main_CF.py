...
# human-readable txt doc.
filename = script_dir / 'output' / f'HT{inc_qrk_n}q_{inc_antiqrk_n}qb_{inc_gl_n}g_to_{out_qrk_n}q_{out_antiqrk_n}qb_{out_gl_n}g_Color_Factor.txt'
